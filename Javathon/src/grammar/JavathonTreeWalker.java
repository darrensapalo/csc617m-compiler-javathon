// $ANTLR 3.5.1 src/grammar/JavathonTreeWalker.g 2013-12-17 13:18:01
...
public class JavathonTreeWalker extends TreeParser {
	...
	// src/grammar/JavathonTreeWalker.g:93:1: expression returns [JNode node] : ( ^( TERNARY expression expression expression ) | ^( In expression expression ) | ^( '||' expression expression ) | ^( '&&' expression expression ) | ^( '==' a= expression b= expression ) | ^( '!=' a= expression b= expression ) | ^( '>=' a= expression b= expression ) | ^( '<=' a= expression b= expression ) | ^( '>' a= expression b= expression ) | ^( '<' a= expression b= expression ) | ^( '+' a= expression b= expression ) | ^( '-' a= expression b= expression ) | ^( '*' a= expression b= expression ) | ^( '/' a= expression b= expression ) | ^( '%' a= expression b= expression ) | ^( '^' a= expression b= expression ) | ^( UNARY_MIN a= expression ) | ^( NEGATE a= expression ) | Number | Bool | Null | lookup );
	public final JNode expression() throws RecognitionException {
		...
		try {
			// src/grammar/JavathonTreeWalker.g:94:3: ( ^( TERNARY expression expression expression ) | ^( In expression expression ) | ^( '||' expression expression ) | ^( '&&' expression expression ) | ^( '==' a= expression b= expression ) | ^( '!=' a= expression b= expression ) | ^( '>=' a= expression b= expression ) | ^( '<=' a= expression b= expression ) | ^( '>' a= expression b= expression ) | ^( '<' a= expression b= expression ) | ^( '+' a= expression b= expression ) | ^( '-' a= expression b= expression ) | ^( '*' a= expression b= expression ) | ^( '/' a= expression b= expression ) | ^( '%' a= expression b= expression ) | ^( '^' a= expression b= expression ) | ^( UNARY_MIN a= expression ) | ^( NEGATE a= expression ) | Number | Bool | Null | lookup )
			int alt12=22;
			switch ( input.LA(1) ) {
			case TERNARY:
				{
			...
			switch (alt12) {
				...
				case 5 :
					...
					node = new NotEqualNode   (a, b);
					}
					break;
				case 6 :
					// src/grammar/JavathonTreeWalker.g:99:6: ^( '!=' a= expression b= expression )
					{
					match(input,NEquals,FOLLOW_NEquals_in_expression707); 
					match(input, Token.DOWN, null); 
				...
				case 7 :
					...
					{
					match(input,GTEquals,FOLLOW_GTEquals_in_expression744); 
					match(input, Token.DOWN, null); 
				...
				case 8 :
					...
					{
					match(input,LTEquals,FOLLOW_LTEquals_in_expression779); 
					match(input, Token.DOWN, null); 
				...
				case 9 :
					...
					{
					match(input,GT,FOLLOW_GT_in_expression814); 
					match(input, Token.DOWN, null); 
				...
				case 10 :
					...
					{
					match(input,LT,FOLLOW_LT_in_expression860); 
					match(input, Token.DOWN, null); 
				...
				case 11 :
					...
					{
					match(input,Add,FOLLOW_Add_in_expression894); 
					match(input, Token.DOWN, null); 
				...
				case 12 :
					...
					{
					match(input,Subtract,FOLLOW_Subtract_in_expression925); 
					match(input, Token.DOWN, null); 
				...
				case 13 :
					...
					{
					match(input,Multiply,FOLLOW_Multiply_in_expression962); 
					match(input, Token.DOWN, null); 
				...
				case 14 :
					...
					{
					match(input,Divide,FOLLOW_Divide_in_expression999); 
					match(input, Token.DOWN, null); 
				...
				case 15 :
					...
					{
					match(input,Modulus,FOLLOW_Modulus_in_expression1036); 
					match(input, Token.DOWN, null); 
				...
				case 16 :
					...
					{
					match(input,Pow,FOLLOW_Pow_in_expression1071); 
					match(input, Token.DOWN, null); 
				...
				case 17 :
					...
					{
					match(input,UNARY_MIN,FOLLOW_UNARY_MIN_in_expression1125); 
					match(input, Token.DOWN, null); 
				...
				case 18 :
					...
					{
					match(input,NEGATE,FOLLOW_NEGATE_in_expression1180); 
					match(input, Token.DOWN, null); 
				...
				case 19 :
					...
					{
					Number10=(CommonTree)match(input,Number,FOLLOW_Number_in_expression1225); 
				...
				case 20 :
					...
					{
					Bool11=(CommonTree)match(input,Bool,FOLLOW_Bool_in_expression1275); 
				...
				case 21 :
					...
					{
					match(input,Null,FOLLOW_Null_in_expression1351); 
					}
					break;
				case 22 :
					// src/grammar/JavathonTreeWalker.g:115:6: lookup
					{
					pushFollow(FOLLOW_lookup_in_expression1360);
					lookup12=lookup();
					state._fsp--;
	...
	public final void list() throws RecognitionException {
		try {
			...
			{
			match(input,LIST,FOLLOW_LIST_in_list1401); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				...
				switch (alt13) {
					case 1 :
						// src/grammar/JavathonTreeWalker.g:119:13: exprList
						{
						pushFollow(FOLLOW_exprList_in_list1403);
						exprList();
						state._fsp--;
		...
		try {
			...
			switch (alt19) {
				case 1 :
					...
					{
					match(input,LOOKUP,FOLLOW_LOOKUP_in_lookup1432); 
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_functionCall_in_lookup1434);
					functionCall();
					state._fsp--;
					...
					switch (alt14) {
						case 1 :
							// src/grammar/JavathonTreeWalker.g:123:28: indexes
							{
							pushFollow(FOLLOW_indexes_in_lookup1436);
							indexes();
							state._fsp--;
				...
				case 2 :
					...
					{
					match(input,LOOKUP,FOLLOW_LOOKUP_in_lookup1448); 
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_list_in_lookup1450);
					list();
					state._fsp--;
					...
					switch (alt15) {
						case 1 :
							// src/grammar/JavathonTreeWalker.g:124:20: indexes
							{
							pushFollow(FOLLOW_indexes_in_lookup1452);
							indexes();
							state._fsp--;
				...
				case 3 :
					...
					{
					match(input,LOOKUP,FOLLOW_LOOKUP_in_lookup1464); 
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_expression_in_lookup1466);
					expression();
					state._fsp--;
				...
				case 4 :
					...
					{
					match(input,LOOKUP,FOLLOW_LOOKUP_in_lookup1481); 
					match(input, Token.DOWN, null); 
					i=(CommonTree)match(input,Identifier,FOLLOW_Identifier_in_lookup1485); 
				...
				case 5 :
					...
					{
					match(input,LOOKUP,FOLLOW_LOOKUP_in_lookup1509); 
					match(input, Token.DOWN, null); 
					s=(CommonTree)match(input,String,FOLLOW_String_in_lookup1513); 
					...
					switch (alt18) {
						case 1 :
							// src/grammar/JavathonTreeWalker.g:132:25: x= indexes
							{
							pushFollow(FOLLOW_indexes_in_lookup1517);
							x=indexes();
							state._fsp--;
	...
	public final List<JNode> indexes() throws RecognitionException {
		...
		try {
			...
			{
			match(input,INDEXES,FOLLOW_INDEXES_in_indexes1560); 
			match(input, Token.DOWN, null); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_expression_in_indexes1563);
	...
	public static final BitSet FOLLOW_expression_in_expression676 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression680 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_NEquals_in_expression707 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression711 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression715 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_GTEquals_in_expression744 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression748 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression752 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_LTEquals_in_expression779 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression783 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression787 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_GT_in_expression814 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression818 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression822 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_LT_in_expression860 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression864 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression868 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_Add_in_expression894 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression898 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression902 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_Subtract_in_expression925 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression929 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression933 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_Multiply_in_expression962 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression966 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression970 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_Divide_in_expression999 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression1003 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression1007 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_Modulus_in_expression1036 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression1040 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression1044 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_Pow_in_expression1071 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression1075 = new BitSet(new long[]{0x0031FF20C2080460L,0x000000000000000BL});
	public static final BitSet FOLLOW_expression_in_expression1079 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_UNARY_MIN_in_expression1125 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression1129 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_NEGATE_in_expression1180 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression1184 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_Number_in_expression1225 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_Bool_in_expression1275 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_Null_in_expression1351 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lookup_in_expression1360 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LIST_in_list1401 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_exprList_in_list1403 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_LOOKUP_in_lookup1432 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_functionCall_in_lookup1434 = new BitSet(new long[]{0x0000000400000008L});
	public static final BitSet FOLLOW_indexes_in_lookup1436 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_LOOKUP_in_lookup1448 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_list_in_lookup1450 = new BitSet(new long[]{0x0000000400000008L});
	public static final BitSet FOLLOW_indexes_in_lookup1452 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_LOOKUP_in_lookup1464 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_lookup1466 = new BitSet(new long[]{0x0000000400000008L});
	public static final BitSet FOLLOW_indexes_in_lookup1468 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_LOOKUP_in_lookup1481 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_Identifier_in_lookup1485 = new BitSet(new long[]{0x0000000400000008L});
	public static final BitSet FOLLOW_indexes_in_lookup1489 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_LOOKUP_in_lookup1509 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_String_in_lookup1513 = new BitSet(new long[]{0x0000000400000008L});
	public static final BitSet FOLLOW_indexes_in_lookup1517 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_INDEXES_in_indexes1560 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_indexes1563 = new BitSet(new long[]{0x0031FF20C2080468L,0x000000000000000BL});
}
